...
El Editor usa CodeMirror 6 para resaltar sintaxis y navegar código de varios lenguajes. El botón `Format` aplica Prettier a los lenguajes compatibles y permanece deshabilitado cuando el fichero no tiene formatter aprobado; las dependencias directas y sus licencias están inventariadas en [THIRD_PARTY_LICENSES.md](THIRD_PARTY_LICENSES.md).
