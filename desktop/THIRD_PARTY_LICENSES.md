...
| [`@usebruno/requests`](https://github.com/usebruno/bruno/tree/main/packages/bruno-requests) | 0.20.0 | HTTP request execution engine for the `http-client` module | MIT | [npm](https://www.npmjs.com/package/@usebruno/requests) |
| [`axios`](https://github.com/axios/axios) | 1.20.0 (pinned via `overrides`) | HTTP client used internally by `@usebruno/requests`; pinned above the version range with known high-severity CVEs that the package's own declared range would otherwise resolve | MIT | [npm](https://www.npmjs.com/package/axios) |
| [`@faker-js/faker`](https://github.com/faker-js/faker) | 10.6.0 (pinned via `overrides`) | Transitive dependency of `@usebruno/requests`; pinned above the version with a known high-severity RCE advisory | MIT | [npm](https://www.npmjs.com/package/@faker-js/faker) |
