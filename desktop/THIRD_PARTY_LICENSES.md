...
| [`axios`](https://github.com/axios/axios) | 1.20.0 | HTTP client for the `http-client` module's request execution engine, used directly rather than via `@usebruno/requests` — see [ADR-0059](../adr/0059-vendor-bruno-as-embedded-http-client.md)'s scope correction | MIT | [npm](https://www.npmjs.com/package/axios) |
