...
- [x] Task: Sincronizar la interacción de Explorer y terminal con la shell actual
  - Acceptance: tema claro/oscuro persistente, navegación lateral redimensionable y persistida por Project, Explorer compacto/expandido con animación fluida, dock inferior redimensionable y terminal PTY con transcript único, prompt mínimo, historial y completado de rutas `cd`.
