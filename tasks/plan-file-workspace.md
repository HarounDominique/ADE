...
**Estado:** completado y validado a nivel de build/tests; bundle `.app` generado y arrancado manualmente en macOS; baseline actual de 96 tests TypeScript y 18 Rust; smoke gráfico automatizado pendiente.
