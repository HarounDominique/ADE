...
Permisos locales, acoplamiento a proveedores, skills inseguras y deriva documental se mitigan con validación nativa, adapters, manifests y sync protocol. Scope creep queda fuera: no editor completo ni cloud. Un commit atómico por tarea y otro por sincronización documental cuando cambie un contrato.
