...
- El turno del agente es visible desde que se envía: el prompt entra en la conversación al pulsar Enter y bajo él un turno en vuelo informa de su estado, del tiempo transcurrido y de la actividad que el proveedor reporta en vivo. El modelo elegido pertenece a la conversación y se persiste con ella; una conversación nueva arranca en `Provider default`. Cada mensaje persistido se puede copiar.
