...
- `Agents` como workbench inline: rail de conversaciones del Project activo agrupadas por Task/General y conversación central dominante; provider, modelo dependiente y Task viven en la cabecera contextual, mientras permisos y envío viven junto al composer. El inspector lateral de actividad, ficheros y skills no forma parte de la vista primaria.
