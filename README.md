...
v0.3 quedó cerrada en macOS: incluye workspace local con terminal PTY nativa, proveedores OpenCode/Codex con sesiones reanudables, skills instalables con permisos por ejecución, Git/GitHub enlazado a Tasks y documentación viva con reconciliación automática. La shell actual añade navegación lateral única, Explorer compacto/expandido con animación, tema claro/oscuro persistente, dock de terminal redimensionable, historial `↑`/`↓`, completado de rutas `cd` con `Tab` y editor interno de ficheros de texto con guardado y descarte. El estado operativo por tarea vive en [tasks/todo.md](tasks/todo.md); los límites y la evidencia de cierre están en [SPEC-v0.3](docu/specs/SPEC-v0.3.md) y [v0.3-close](docu/releases/v0.3-close.md).
