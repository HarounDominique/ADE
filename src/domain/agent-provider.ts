...
export const nativeProviders: readonly AgentProvider[] = [
  ...
  { id: "codex", label: "Codex", transport: "cli", capability: ["implement", "review"], auth: "external", models: [providerDefault, { id: "gpt-5.6-terra", label: "GPT-5.6 Terra" }, { id: "gpt-5.6-sol", label: "GPT-5.6 Sol" }, { id: "gpt-5.6-luna", label: "GPT-5.6 Luna" }, { id: "gpt-5.5", label: "GPT-5.5" }] },
