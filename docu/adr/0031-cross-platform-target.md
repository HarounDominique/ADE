# ADR-0031: Assay como producto multiplataforma verificado por CI
...
1. Assay es un producto multiplataforma: macOS, Windows y Linux son objetivos declarados, no adaptaciones oportunistas.
...
Rechazado por el objetivo de producto: Assay dirige agentes sobre repositorios locales, y esa población no es mayoritariamente macOS. Mantener una sola plataforma tampoco era gratis: las asunciones seguían filtrándose sin marca.
