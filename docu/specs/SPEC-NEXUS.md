...
- 2026-09-03 — v0.2-review-gates — Changes consume `change.review`, muestra gates/evidencia/finding(s) y distingue gates pendientes; quedan servicios locales y smoke de rehidratación.
...
- 2026-09-03 — v0.2-rehydration — El test de reinicio de store conserva Task, runtime evidence, ChangeSet y Review; 39 tests TypeScript pasan. El smoke empaquetado final queda cubierto por `desktop:smoke`.
