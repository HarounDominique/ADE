...
- 2026-09-06 — chatgpt-desktop-agents-audit — Se documenta la siguiente iteración de `Agents` a partir de referencias oficiales de ChatGPT Desktop y los límites propios de ADE. [chatgpt-desktop-agents-audit](../knowledge/chatgpt-desktop-agents-audit.md) y [ADR-0029](../adr/0029-chatgpt-inspired-agent-workbench.md) fijan: conversaciones sólo del Project activo, rail por Task/`General`, thread sin inspector Git y modelo por turno dentro del provider de la sesión. Queda `proposed`, pendiente de implementación.
