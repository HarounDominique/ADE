...
La siguiente iteración de esta superficie seguirá el contrato de paridad operativa con GitHub Desktop definido en [ADR-0028](../adr/0028-github-desktop-version-control-parity.md) y detallado en la [auditoría de GitHub Desktop](../knowledge/github-desktop-audit.md). El objetivo es conservar el contrato Git existente, pero reorganizar la jerarquía alrededor de un diff dominante, una lista compacta de cambios, una historia navegable y selectores persistentes de Project/branch. La paridad no implica copiar la identidad visual ni introducir operaciones que ADE todavía no soporte.
