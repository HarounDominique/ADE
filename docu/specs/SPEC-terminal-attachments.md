...
- Tests de seguridad para impedir que una ruta fuera de la raíz autorizada se inyecte en
  la terminal o se entregue al runtime.
...
- **Always:** validar que el path existe y pertenece al Project antes de aceptarlo;
  mostrar feedback de drop; escapar según el shell; no ejecutar el contenido ni enviar el
  prompt hasta una acción explícita del operador; mantener la semántica provider-neutral.
- **Ask first:** añadir dependencias nativas, cambiar el protocolo de un runtime, subir
  contenido a Claude/Codex/OpenCode o ampliar el acceso fuera de la raíz del Project.
...
5. Rutas fuera del Project, inexistentes, duplicadas o no representables se rechazan con
   feedback accionable y no llegan al PTY ni al runtime.
...
- Confirmar si el drop debe aceptar únicamente ficheros del Project o también carpetas.
